      ...
      <main className="max-w-[800px] mx-auto pt-[56px] px-6 pb-[80px]">
        ...
        <div className="space-y-[14px] text-[rgba(255,255,255,0.72)]">
          ...
          <p>
            ...
            <strong className="text-white">http://bzstream-podcast.ru</strong>.
          </p>
          ...
          <p>
            2.5. <strong>Обезличивание персональных данных</strong> — действия,
          ...
          <p>
            ...
            Пользователю веб-сайта http://bzstream-podcast.ru.
          </p>
          <p>
            2.9.{" "}
            <strong>
            ...
            предоставлен субъектом путём дачи согласия.
          </p>
          <p>
          ...
          <p>
            2.14. <strong>Уничтожение персональных данных</strong> — действия, в
          ...
          <ul className="list-disc pl-[1.4em] space-y-[6px]">
            ...
            <li>
              сообщать в уполномоченный орган необходимую информацию в течение
              10 дней;
            </li>
            <li>
              публиковать или обеспечивать неограниченный доступ к настоящей
              Политике;
            </li>
            <li>
            ...
            <li>
              прекратить передачу и уничтожить данные в случаях, предусмотренных
              законом.
            </li>
          </ul>
          ...
          <ul className="list-disc pl-[1.4em] space-y-[6px]">
            ...
            <li>
              выдвигать условие предварительного согласия при обработке в целях
              продвижения товаров;
            </li>
          ...
          <h2 className="font-['Inter_Tight',_sans-serif] text-[clamp(18px,2.5vw,22px)] font-medium text-white mt-10 mb-[14px]">
          ...
          <p>5.5. Содержание и объём данных соответствуют заявленным целям.</p>
          <p>
              ...
              <tbody>
                <tr>
                  <td className="p-[10px_14px] border border-[rgba(255,255,255,0.1)] align-top">
                    Информирование Пользователя; коммуникация для оказания услуг
                  </td>
                  <td className="p-[10px_14px] border border-[rgba(255,255,255,0.1)] align-top">
          ...
          <p>
            7.2. Обработка необходима для достижения целей, предусмотренных
            законом.
          </p>
          <p>
          ...
          <p>7.5. Обработка необходима для осуществления прав Оператора.</p>

          <h2 className="font-['Inter_Tight',_sans-serif] text-[clamp(18px,2.5vw,22px)] font-medium text-white mt-10 mb-[14px]">
            8. Порядок сбора, хранения, передачи данных
          </h2>
          <p>
            8.1. Оператор обеспечивает сохранность данных и исключает доступ
            неуполномоченных лиц.
          </p>
          <p>
            8.2. Данные никогда не будут переданы третьим лицам без согласия,
            кроме случаев исполнения закона.
          </p>
          <p>
          ...
          <p>
            9.1. Сбор, запись, систематизация, накопление, хранение, уточнение,
          ...
          <p>
            10.2. Оператор обязан получить необходимые сведения от иностранных
            органов власти до подачи уведомления.
          </p>
          ...
          <p>
            Оператор и иные лица обязаны не раскрывать данные третьим лицам без
            согласия субъекта.
          </p>
          ...
          <p>12.2. Политика действует бессрочно до замены её новой версией.</p>
          <p>
          ...
          <div className="bg-[rgba(251,65,20,0.07)] border-l-[3px] border-[rgba(251,65,20,0.5)] rounded-r-[6px] p-[14px_18px] my-10 text-[rgba(255,255,255,0.72)] text-[14px] leading-[1.6]">
            Также ознакомьтесь с документом{" "}
            <Link
              href="/consent"
              target="_blank"
